...
const en: LandingCopy = {
  ...
  heroSecondary: "See demos",
  heroTrust: "Always free · English · Hindi · Marathi",
  trustLabel: "Built for Maharashtra-style circles & pan-India organisers",
  demosEyebrow: "Product demos",
  demosTitle: "Watch the real app — not mockups",
  demosSub: "Six short recordings from Bhishi Circle. Pick a step and watch the phone.",
  demos: [
    {
      id: "create",
      short: "Create",
  ...
  toolsEyebrow: "Tools",
  toolsTitle: "Everything organisers need — free",
  toolsSub: "Collections, WhatsApp reach, PDFs and three languages in one place.",
  tools: [
  ...
  compareEyebrow: "Why switch",
  compareTitle: "Notebook chaos vs clear digital books",
...
const hi: LandingCopy = {
  ...
  demosEyebrow: "प्रॉडक्ट डेमो",
  demosTitle: "असली ऐप देखें — मॉकअप नहीं",
  demosSub: "Bhishi Circle से छह छोटी रिकॉर्डिंग। स्टेप चुनें, फ़ोन में देखें।",
  demos: [
    {
      id: "create",
      short: "बनाएँ",
  ...
  toolsEyebrow: "टूल्स",
  toolsTitle: "आयोजकों को जो चाहिए — मुफ़्त",
  toolsSub: "वसूली, WhatsApp, PDF और तीन भाषाएँ एक जगह।",
  tools: [
  ...
  compareEyebrow: "क्यों बदलें",
  compareTitle: "कापी की उलझन बनाम साफ़ डिजिटल किताब",
...
const mr: LandingCopy = {
  ...
  demosEyebrow: "प्रॉडक्ट डेमो",
  demosTitle: "खरे अॅप पहा — मॉकअप नाही",
  demosSub: "Bhishi Circle मधील सहा छोटी रेकॉर्डिंग. स्टेप निवडा, फोनमध्ये पहा.",
  demos: [
    {
      id: "create",
      short: "तयार",
  ...
  toolsEyebrow: "साधने",
  toolsTitle: "आयोजकांना जे हवे — मोफत",
  toolsSub: "वसुली, WhatsApp, PDF आणि तीन भाषा एका ठिकाणी.",
  tools: [
  ...
  compareEyebrow: "का बदलावे",
  compareTitle: "कॉपीचा गोंधळ विरुद्ध स्वच्छ डिजिटल वही",
