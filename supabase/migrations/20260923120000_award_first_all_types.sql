-- Award-first hapta order for all bhishi types (reuse auction_style).
-- award_first: skip collect-before-award and cash-on-hand gates.
-- auction_peer: auction-only bid÷n self-contribution (previous auction_first meaning).
